import {
    ...
    Grid, Input,
    Slider, Table, TableBody, TableCell, TableRow, TextField, Typography
} from "@mui/material";
import {
...
jsaruco2.AR.DICTIONARIES['ARUCO_4X4_1000'] = {
    nBits: 16,
    tau: 3,
...
jsaruco2.AR.Dictionary.prototype.generateSVGForPrint = function (id) {
